        ...
        <div class="row">
            ...
            <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="../upload/${product.filename}"  onerror="this.src='/project/img/no-image-icon-23492.png'">
                <%--                        <div class="sale pp-sale">Sale</div>--%>
                                ...
                                <div class="pi-text">
                                    <div class="catagory-name">${product.manufacturer}</div>
                                    <a href="/project/product/productDetail?id=${product.id}">
                                        <h5>${product.name}</h5>
                                    </a>
